...
//         _GT(typeof(TestEventListener)),
       ...
       //-----------------Add for project FiFA-----------------
		_GT(typeof(Rect)),
		_GT(typeof(GUI)),
		_GT(typeof(GUILayout)),
		_GT(typeof(UIEventListener)),
		_GT(typeof(UIBaseWindowLua)),
		_GT(typeof(NetWorkHandler)),
		_GT(typeof(DataSystem)),
		_GT(typeof(GameMain)),
		_GT(typeof(WindowMgr)),
		_GT(typeof(UIHelper)),
		_GT(typeof(SDKMgr)),
		_GT(typeof(AudioMgr)),
		_GT(typeof(LuaServerTime)),
		_GT(typeof(UIScoutAnim)),
        _GT(typeof(RoleHelper)), 
        _GT(typeof(CoachHelper)),
        _GT(typeof(LogManager)),
        _GT(typeof(Tutorial)),
        _GT(typeof(DelayDeal)),
        _GT(typeof(TableWordFilter)),
        ...
        _GT(typeof(UILuaTween)),
    };


//    [MenuItem("FIFA Editor/Lua/Gen Lua Wrap Files", false, 11)]
    ...
    static void GenLuaBinder()
    {
        ...
        string[] files = Directory.GetFiles("Assets/Scripts/Utility/uLua/LuaWrap/", "*.cs", SearchOption.TopDirectoryOnly);
        ...
        string file = AppConst.uLuaPath + "/Base/LuaBinder.cs";
...
//    [MenuItem("FIFA Editor/Lua/Clear LuaBinder File + Wrap Files", false, 13)]
    public static void ClearLuaBinder()
    {
        ...
        //}
        ClearFiles(AppConst.uLuaPath + "/LuaWrap/");
        AssetDatabase.Refresh();
    }
